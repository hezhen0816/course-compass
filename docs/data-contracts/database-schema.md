...
- `scripts/dry_run_typed_planner_backfill_apply.py` 只做 dry-run：
...
bash scripts/python.sh scripts/dry_run_typed_planner_backfill_apply.py /tmp/course-planner-backfill-preview --output /tmp/course-planner-backfill-preview/apply-dry-run.json
```
