...
`backend/services/typed_planner/backfill.py` 是 typed schema 切換前的離線預覽與對帳核心；`scripts/typed_planner/preview_backfill.py`、`scripts/typed_planner/plan_backfill.py` 與 `scripts/typed_planner/dry_run_apply.py` 是本機 CLI wrappers。
...
- `scripts/typed_planner/dry_run_apply.py` 只做 dry-run：
...
```bash
bash scripts/python.sh scripts/typed_planner/preview_backfill.py user_data_export.json --counts-only
bash scripts/python.sh scripts/typed_planner/preview_backfill.py user_data_export.json --package-dir /tmp/course-planner-backfill-preview
bash scripts/python.sh scripts/typed_planner/plan_backfill.py /tmp/course-planner-backfill-preview --output /tmp/course-planner-backfill-preview/apply-plan.json
bash scripts/python.sh scripts/typed_planner/plan_backfill.py /tmp/course-planner-backfill-preview --format batches --output /tmp/course-planner-backfill-preview/apply-batches.json
bash scripts/python.sh scripts/typed_planner/dry_run_apply.py /tmp/course-planner-backfill-preview --output /tmp/course-planner-backfill-preview/apply-dry-run.json
```
